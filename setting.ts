...
export class AOSRSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'The baseline of the reviewing frequency. The review interval is doubled by ease /100. The smaller the number, the higher the frequency. Recommend:250.'
      )
      .addText((text) =>
        text
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Additional interval days are added to the normal review interval when you choose the easy option. The bigger it is, the later the next schedule will be. Recommend:1.'
      )
      .addText((text) =>
        text
          .setPlaceholder('0-10')
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Additional interval days are reduced to the normal review interval when you choose a difficult option. The bigger it is, the sooner the next schedule will be. Recommend:1.'
      )
      .addText((text) =>
        text
          .setPlaceholder('0-10')
